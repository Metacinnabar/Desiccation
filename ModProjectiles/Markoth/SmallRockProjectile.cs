...
namespace Desiccation.ModProjectiles.Markoth
{
	public class SmallRockProjectile : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			if (NPC.downedBoss1 && MyPlayer.ZoneRockLayerHeight && !NPC.AnyNPCs(NPCType<ModNPCs.Markoth.Markoth>()))
			{
				Player player = new Player();
				//Boss Sound
				Main.PlaySound(SoundID.Roar, player.position, 0);
				//Boss Spawn
				NPC.SpawnOnPlayer(player.whoAmI, NPCType<ModNPCs.Markoth.Markoth>());
			}
		}
